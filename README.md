...
#### Example: cifar10 
After changing the data path in `utils/params.py`, run
```
python -W ignore train.py
```
to train the cleanEEGNet on the OpenNeuro data.

For inference, load the pretrained model and use it on your custom data (follow normalisation instructions from the paper).
### Citation   
```
@article{YourName,
  title={Your Title},
